...
<a class="nav-link btn btn-primary"  href="InicioSesion.aspx">Cerrar Sesión</a>
   ...
   <div class="container mt-5 pt-5">
    <asp:GridView ID="gvPacientes" runat="server" PageSize="5" PagerStyle-HorizontalAlign="Center" PagerStyle-Font-Size="Large" DataKeyNames="ID_Paciente" AutoGenerateColumns="False" AllowPaging="True" CssClass="grid-style" Width="94%" HorizontalAlign="Center" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" AutoGenerateDeleteButton="True" OnRowDeleting="gvPaciente_RowDeleting" AutoGenerateEditButton="True" OnRowCancelingEdit="gvPaciente_RowCancelingEdit" OnRowEditing="gvPaciente_RowEditing" OnRowUpdating="gvPaciente_RowUpdating" OnPageIndexChanging="gvPacientes_PageIndexChanging">
    <Columns>
