...
<asp:GridView ID="gvMedicos" runat="server" AllowPaging="true" AutoGenerateColumns="false" CssClass="grid-style" Width="100%" HorizontalAlign="Center" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="gvMedicos_RowDeleting" DataKeyNames="Legajo, Usuario" OnRowCancelingEdit="gvMedicos_RowCancelingEdit" OnRowEditing="gvMedicos_RowEditing" OnRowUpdating="gvMedicos_RowUpdating">
    <Columns>
        ...
        <asp:TemplateField HeaderText="Legajo">
            <EditItemTemplate>
                <asp:TextBox ID="txtEditLegajo" runat="server" Text='<%# Bind("Legajo") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="DNI">
            <EditItemTemplate>
                <asp:TextBox ID="txtEditDNI" runat="server" Text='<%# Bind("DNI") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
