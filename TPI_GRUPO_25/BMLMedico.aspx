...
<a class="nav-link" href="InicioSesion.aspx">Cerrar Sesión</a>
  ...
  <div class="container mt-5 pt-5">
    <asp:GridView ID="gvMedicos" runat="server" AllowPaging="True" CssClass="grid-style" Width="100%" HorizontalAlign="Center" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
        <Columns>
