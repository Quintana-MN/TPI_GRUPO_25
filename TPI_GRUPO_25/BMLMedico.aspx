...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container mt-5 pt-5">
   <asp:GridView ID="gvMedico" runat="server" AutoGenerateColumns="False" AllowPaging="True" CssClass="grid-style" Width="94%" HorizontalAlign="Center" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
   <Columns>
